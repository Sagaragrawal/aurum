...
class RetailerSelectionTest {
    ...
    @Test
    fun fourSelectedTapFifthSelectsAll() {
        val current = setOf("amazon.in", "ajio.com", "flipkart.com", "myntra.com")
        assertEquals(all, RetailerSelection.toggle(current, "shopsy.in", all))
    }
