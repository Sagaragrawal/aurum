...
object RetailerWebView {
    ...
    fun create(
        ...
        pincode: String = com.aurum.intelligence.data.LocationHelper.DEFAULT_PINCODE,
        ...
        webViewClient = object : WebViewClient() {
            ...
            override fun onPageCommitVisible(view: WebView, url: String) {
                ...
                runCatching {
                    view.evaluateJavascript(com.aurum.intelligence.data.LocationHelper.buildPincodeInjectionScript(pincode, latitude, longitude), null)
                }
            ...
            override fun shouldInterceptRequest(view: WebView, request: WebResourceRequest): WebResourceResponse? {
                ...
                // Aggressively block images, fonts, and styles to bypass rendering lag
                if (urlStr.endsWith(".png") || urlStr.endsWith(".jpg") || urlStr.endsWith(".jpeg") || 
                    urlStr.endsWith(".webp") || urlStr.endsWith(".gif") || urlStr.endsWith(".css") || 
                    urlStr.endsWith(".woff2") || urlStr.endsWith(".woff") || urlStr.endsWith(".ttf") ||
                    path.endsWith(".png") || path.endsWith(".jpg") || path.endsWith(".css") || 
                    urlStr.contains("images-amazon.com/images/") || urlStr.contains("rukminim2.flixcart.com/image/")) {
                    return WebResourceResponse("text/plain", "utf-8", 204, "No Content", emptyMap(), java.io.ByteArrayInputStream(ByteArray(0)))
                }

                // Block known heavy third-party trackers and ads, but provide a dummy JS stub to prevent ReferenceErrors
                if (cleartextHost != null && (cleartextHost.contains("google-analytics") || 
                    cleartextHost.contains("doubleclick") || cleartextHost.contains("facebook.com") || 
                    cleartextHost.contains("criteo") || cleartextHost.contains("googletagmanager"))) {
                    val stubJs = "window.ga = function(){}; window.fbq = function(){}; window.gtag = function(){}; window.dataLayer = [];"
                    return WebResourceResponse("application/javascript", "utf-8", 200, "OK", emptyMap(), java.io.ByteArrayInputStream(stubJs.toByteArray()))
                }
